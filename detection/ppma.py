...
class MambaAttentionChunkDouble(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, value_factor=1):
        ...
        # self.path_embed = PathEmbeding2DV0(embed_dim, num_heads, chunkwise_recurrent=True)
...
class Backbone_Mamba2TransformerDouble(Mamba2TransformerDouble):
    ...
    def load_pretrained(self, ckpt=None, key="model"):
        ...
        try:
            ...
            print(f"Failed loading checkpoint form {ckpt}: \n{e}")
            import sys
            sys.exit()
...
class mamba2vit_tiny(Backbone_Mamba2TransformerDouble):
...
@BACKBONES.register_module()
class mamba2vit_small(Backbone_Mamba2TransformerDouble):
    def __init__(self, **kwargs):
        super().__init__(
        out_indices=(0, 1, 2, 3),
        pretrained=kwargs['pretrained'],
...
@BACKBONES.register_module()
class mamba2vit_base(Backbone_Mamba2TransformerDouble):
    def __init__(self, **kwargs):
        super().__init__(
        out_indices=(0, 1, 2, 3),
        pretrained=kwargs['pretrained'],
