...
class Backbone_PPMAViT(PPMAViT):
...
class ppma_tiny(Backbone_PPMAViT):
...
@BACKBONES.register_module()
class ppma_small(Backbone_PPMAViT):
    def __init__(self, **kwargs):
        super().__init__(
        out_indices=(0, 1, 2, 3),
        pretrained=kwargs['pretrained'],
...
@BACKBONES.register_module()
class ppma_base(Backbone_PPMAViT):
    def __init__(self, **kwargs):
        super().__init__(
        out_indices=(0, 1, 2, 3),
        pretrained=kwargs['pretrained'],
